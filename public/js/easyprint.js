! function(t, e) {
    ...
    L.Control.EasyPrint = L.Control.extend({
        ...
        _toggleControls: function(t) {
            var e1 = document.getElementsByClassName("leaflet-control-zoom")[0];
            var e2 = document.getElementsByClassName("leaflet-control-layers")[0];
            var e3 = document.getElementsByClassName("leaflet-control-easyPrint")[0];
            if (t) {
